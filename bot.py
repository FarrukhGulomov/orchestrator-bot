...
async def cmd_start(message: Message) -> None:
    if not _is_allowed(message.chat.id):
        return
    await message.answer(
        "Senior Biznes Analitik AI Jamoasi — tayyor!\n\n"
        "Menga har qanday BA ishi haqida yozing — avtomatik to'g'ri mutaxassisga "
        "yo'naltiraman. Jamoa tarkibi:\n"
        "- Senior BA — talablar, user story, GAP tahlil\n"
        "- Data Analyst — SQL, KPI, metrics\n"
        "- BI Analyst — Power BI, Tableau, dashboard\n"
        "- Process Analyst — BPMN, jarayon xaritalash\n"
        "- Financial Analyst — P&L, prognoz, moliyaviy model\n"
        "- Market Analyst — bozor tahlili, SWOT, raqobatchilar\n"
        "- Requirements Engineer — BRD/FRS hujjatlar\n"
        "- Data Governance — ma'lumotlar sifati, MDM\n"
        "- PM, System Analyst, QA, Project Manager, Tech Consultant\n\n"
